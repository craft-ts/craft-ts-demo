import{A as e,x as t}from"./hyperscript-LLgsElhq.js";var n={idle:[`🛌`,`Idle`,`gray`],error:[`❌`,`Error`,`red`],loading:[`⏳`,`Loading`,`orange`],reloading:[`🔄`,`Reloading`,`orange`],resolved:[`✅`,`Loaded`,`green`],local:[`📦`,`Local`,`blue`],exception:[`⚠️`,`Exception`,`red`]},r=e(`StatusComponent`,{styles:`
      :scope {
    ...
    `},e=>({status:e}),({status:e})=>t({class:`badge-container`},[t({class:`status-emoji`},function*(){return n[yield*e()][0]}),t({class:function*(){return`badge badge-${n[yield*e()][2]}`}},function*(){return n[yield*e()][1]})]));export{r as t};